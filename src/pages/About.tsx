...
const values = [
  ...
  { icon: Users, title: "Community", description: "We build strong, lasting partnerships with families and actively support the Houston and Deer Park communities we call home." },
              ...
              >
                ...
                <div className="bg-card rounded-2xl overflow-hidden border border-border shadow-md lg:col-span-1">
                  ...
                  <div className="p-8">
                    ...
                    <p className="text-muted-foreground font-body leading-relaxed">
                      As hands-on owners, Hugh and Nidhi are regularly present at both the Houston and Deer Park locations, ensuring the values they built this academy on — safety, love, and excellence — are felt in every classroom, every day.
                    </p>
